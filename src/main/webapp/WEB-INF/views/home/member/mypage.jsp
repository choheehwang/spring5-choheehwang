				...
				<fieldset>
					...
					<ul class="app_list">
						...
						<li class="clear">
							...
							<div class="app_content"><input type="user_pw" name="user_pwd" class="w100p" id="user_pw_lbl" placeholder="비밀번호를 입력해주세요" required/></div>
						</li>
						<li class="clear">
							<label for="user_pw_chk_lbl" class="tit_lbl pilsoo_item">비밀번호확인</label>
							<div class="app_content"><input type="user_pw_chk" name="user_pw_chk" class="w100p" id="user_pw_chk_lbl" placeholder="비밀번로를 다시 입력해주세요" required/></div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content radio_area">
								...
								<input type="radio" readonly name="disable" class="css-radio" id="disable_lbl" />
